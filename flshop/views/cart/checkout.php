            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    ...
                    <?php else: ?>
                        ...
                        <p>Вибрано товарів: <?php echo $totalQuantity; ?>, на суму: <?php echo $totalPrice; ?> грн</p><br/>
                        ...
                        <?php if (!$result): ?>                        
                            ...
                            <div class="col-sm-4">
                                ...
                                <p>Для оформления замовлення заповніть форму. Наш менеджер зв'яжеться з вами з Вами.</p>
